...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void>{
    ...
    protected GetAccountInfo mActivity;

    protected String mScope;
    protected String mEmail;

    AbstractGetNameTask(GetAccountInfo activity, String email, String scope) {
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        if (sc == 200) {
          ...
          is.close();
          String User_Id = mEmail+"("+name+")";
          
          UserInfomation Userinfo = new UserInfomation();
          Userinfo.onSaveId(User_Id, mActivity);
          
          mActivity.NextPage(true);
          return;
        } else if (sc == 401) {
